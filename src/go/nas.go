...
func (ue *UE) PowerON() {
	...
	ue.SUPI = fmt.Sprintf("%03d%02d%s", ue.MCC, ue.MNC, ue.MSIN)
}
...
func (ue *UE) decNASMessageContainer(pdu *[]byte) {
	ue.dprint("NAS message container")
	length := int(readPduUint16(pdu))
	ue.indent++
