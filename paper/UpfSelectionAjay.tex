...
N4/PFCP session context database and internal telemetry.
...
yielding zero eMBB violations. However, URLLC MEC delay hits
...
than the EGT Nash equilibrium (19.4~ms). This exposes the classical
Price of Anarchy: the decentralised EGT controller converges to a
Nash-stable operating point that is strictly mathematically stable,
but Pareto-dominated by a centrally engineered optimal fraction.
